...
1.  Finalize review for uses of symptom onset information
2.  Refine current simulation of line list issues
    i.  More realistic features / Alternative line list simulators
3.  Identify further key issue to include in simulations
    i. Extend generative model
4.  Review details of symptom onset reporting
    i.  Investigate real-world datasets with detailed symptom information (some available from university hospitals)
    ii. Real-world case report forms / recommendations for symptom definitions, e.g. WHO guidelines
5.  Write up guideline/paper
    i. summarize the findings from the review and simulations
    ii. create illustrative figures
    ii.  create a checklist to self-evaluate linelist (for data manager)
