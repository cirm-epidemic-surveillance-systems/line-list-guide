...
9. **Create a timeline sequence**
 Capture exposure and symptoms timeline by creating a sequence. For example, Exposure date → first mild symptom → first major symptom → healthcare visit → hospitalization

10. **Geo-tag Onset Context**
Capture where the case was physically located when symptoms began (e.g., home, work, travel), especially useful for spatial-temporal modeling.
