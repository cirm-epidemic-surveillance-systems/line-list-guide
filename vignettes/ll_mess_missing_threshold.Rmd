---
title: "Estimating delays from line list data with symptom onset date recall bias"
---
...
ll_all <- bind_rows(list(
  "0" = ll_clean,
  "1" = ll_clean |> add_missing(prop = 0.5, threshold_days = 1),
  "2" = ll_clean |> add_missing(prop = 0.5, threshold_days = 2),
  "3" = ll_clean |> add_missing(prop = 0.5, threshold_days = 3),
  "4" = ll_clean |> add_missing(prop = 0.5, threshold_days = 4),
  "5" = ll_clean |> add_missing(prop = 0.5, threshold_days = 5),
  "6" = ll_clean |> add_missing(prop = 0.5, threshold_days = 6),
  "7" = ll_clean |> add_missing(prop = 0.5, threshold_days = 7),
  "8" = ll_clean |> add_missing(prop = 0.5, threshold_days = 8),
  "9" = ll_clean |> add_missing(prop = 0.5, threshold_days = 9)
  ),
  .id = "ll_source")
```
...
c(delay_admission_estimates, delay_admission_estimates_natural) |> 
  ...
  labs(y = "Threshold for 50% missing onset probability", x = "Value") +
  ggtitle("Delay between date of onset and date of admission") +
  theme_bw() +
