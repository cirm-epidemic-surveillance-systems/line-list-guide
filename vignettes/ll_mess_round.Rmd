---
title: "Estimating delays from line list data with rounding of symptom onset dates to weeks"
---
...
ll_all <- bind_rows(list(
  "0" = ll_clean,
  "10" = ll_clean |> round_dates(prop = 0.1),
  "20" = ll_clean |> round_dates(prop = 0.2),
  "30" = ll_clean |> round_dates(prop = 0.3),
  "40" = ll_clean |> round_dates(prop = 0.4),
  "50" = ll_clean |> round_dates(prop = 0.5),
  "60" = ll_clean |> round_dates(prop = 0.6),
  "70" = ll_clean |> round_dates(prop = 0.7),
  "80" = ll_clean |> round_dates(prop = 0.8),
  "90" = ll_clean |> round_dates(prop = 0.9)
  ),
  .id = "ll_source")
```
...
c(delay_admission_estimates, delay_admission_estimates_natural) |> 
  ...
  labs(y = "Share of rounded onset dates", x = "Value") +
  ggtitle("Delay between date of onset and date of admission") +
  theme_bw() +
